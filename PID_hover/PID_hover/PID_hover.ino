...
void setup() {
  ...
  frontLeftMotor.attach(MOTOR_PIN_3);
  frontRightMotor.attach(MOTOR_PIN_2);
  backLeftMotor.attach(MOTOR_PIN_1);
...
//  pitch_adj = pitch_P_gain * pitch + pitch_D_gain * GyroX + pitch_I_gain * pitch_integral;
  ...
  if (rightSwitch < 1050 & rightSwitch > 950){
      ...
      frontLeftSend = throttle_control + pitchSensitivity * (pitch_control - 1500) + pitch_P_gain * pitch  + rollSensitivity * (roll_control - 1500) - roll_P_gain * roll;
      ...
      backLeftSend = throttle_control + pitchSensitivity * (1500 - pitch_control) - pitch_P_gain * pitch + rollSensitivity * (roll_control - 1500) - roll_P_gain * roll;
